"""Interleave two streams where children are derived with different indices."""
import subprocess
import numpy as np
import sys
...
# derive second child by folding in a nonzero index
child2 = jax.random.fold_in(parent2, 1)
