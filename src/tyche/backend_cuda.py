...
tyche_v1_hash_p.def_impl(lambda key, weight_matrices, **kwargs: xla.apply_primitive(tyche_v1_hash_p, key, weight_matrices, **kwargs))

@tyche_v1_hash_p.def_abstract_eval
def tyche_v1_hash_abstract_eval(key, weight_matrices, *, offset, num_tiles, T, R, embedding_type, key_mix):
    return jax_core.ShapedArray((num_tiles, T, T), jnp.int8)

def tyche_v1_hash_lowering(ctx, key, weight_matrices, *, offset, num_tiles, T, R, embedding_type, key_mix):
